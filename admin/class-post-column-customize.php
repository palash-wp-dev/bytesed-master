...
if (!class_exists('Irtech_Post_Column_Customize')){
	class Irtech_Post_Column_Customize{
		//$instance variable
		...
		public function edit_practice_area_columns($columns){
			...
			$columns['title'] = esc_html__('Title','irtech-master');
			$columns['thumbnail'] = '<a href="edit.php?post_type=practice-area&orderby=title&order='.urlencode($order).'">'.esc_html__('Thumbnail','irtech-master').'</a>';
			...
			$columns['date'] = esc_html__('Date','irtech-master');
			return $columns;
		}
		/**
		 * edit case study
		...
		public function edit_case_study_columns($columns){
			...
			$columns['cb'] = '<input type="checkbox" />';
			$columns['title'] = esc_html__('Title','irtech-master');
			$columns['thumbnail'] = '<a href="edit.php?post_type=case-study&orderby=title&order='.urlencode($order).'">'.esc_html__('Thumbnail','irtech-master').'</a>';
		...
		public function edit_attorney_columns($columns){
			...
			$columns['cb'] = '<input type="checkbox" />';
			$columns['title'] = esc_html__('Title','irtech-master');
			$columns['thumbnail'] = '<a href="edit.php?post_type=attorney&orderby=title&order='.urlencode($order).'">'.esc_html__('Thumbnail','irtech-master').'</a>';
	...
	if ( class_exists('Irtech_Post_Column_Customize')){
		Irtech_Post_Column_Customize::getInstance();
	}
}