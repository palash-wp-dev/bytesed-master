...
namespace Elementor;
class Irtech_Accordion_One extends Widget_Base {
    ...
    public function get_name() {
        return 'irtech-accordion-one-widget';
    }
    ...
    public function get_title() {
        return esc_html__( 'Accordion 01', 'irtech-master' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control( 'accordion_items', [
            'label'       => esc_html__( 'Accordion Item', 'irtech-master' ),
            'type'        => Controls_Manager::REPEATER,
            'default'     => [
                [
                    'title'        => esc_html__( 'How Irtech help you?', 'irtech-master' ),
                    'description' => esc_html__('Duis aute irure dolor reprehenderit in voluptate velit essle cillum dolore eu fugiat nulla pariatur. Excepteur sint ocaec at cupdatat proident suntin culpa qui officia deserunt mol anim id esa laborum perspiciat.','irtech-master'),
                ]
            ],
            'fields'      => [
                [
...
Plugin::instance()->widgets_manager->register_widget_type( new Irtech_Accordion_One() );