...
namespace Elementor;
class Irtech_Button_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'irtech-button-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Button With Icon', 'irtech-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'     => esc_html__( 'Phone', 'irtech-master' )
			]
		);
		$this->add_control(
			'url',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Button Styling', 'irtech-master' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Icon Styling', 'irtech-master' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Irtech_Button_One_Widget() );