...
namespace Elementor;
class Irtech_Info_Box_Two_Widget extends Widget_Base
{
    ...
    {
        return 'irtech-info-box-two-widget';
    }
    ...
    {
        return esc_html__('Info Box Two', 'irtech-master');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__('(|) , {our_time} & {vis_time}', 'irtech-master'),
                'default' => esc_html__('+111 222 333 444', 'irtech-master')
            ]
        );
        $this->add_control(
            'icon',
...
Plugin::instance()->widgets_manager->register_widget_type(new Irtech_Info_Box_Two_Widget());