...
namespace Elementor;
class Irtech_Latest_Product_Grid_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'irtech-latest-product-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Latest Products Grid', 'irtech-master' );
	}
            ...
            <ul class="latest-product-list-wrap">
				<?php
                    while ($post_data->have_posts()):$post_data->the_post();
	                    ...
	                    $envato_item_id = get_post_meta(get_the_ID(),'irtech_envato_product_id',true);
	                    ...
	                    if($product_img_url == '' && !empty($envato_item_id)){
	                       // echo 'inside condition';
	                        $thumbanil_image_id = \Irtech_Envato::get_product_thumbnail_by_id($envato_item_id,get_the_ID());
                        ...
                        if(empty($price) && !empty($envato_item_id)){
                            $price = \Irtech_Envato::get_product_price_by_id($envato_item_id);
...
Plugin::instance()->widgets_manager->register_widget_type( new Irtech_Latest_Product_Grid_One_Widget() );