...
namespace Elementor;
class Irtech_Testimonial_One_Widget extends Widget_Base {
	...
	public function get_name() {
		return 'irtech-testimonial-one-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'Testimonial One', 'irtech-master' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'theme', [
			...
			'options' => array(
				''      => esc_html__( 'White', 'irtech-master' ),
				'black' => esc_html__( 'Black', 'irtech-master' )
			),
			'default' => 'black'
		] );
		$this->add_control( 'testimonial_items', [
			'label'       => esc_html__( 'Testimonial Item', 'irtech-master' ),
			...
			'fields'      => [
				...
				[
					...
					'default'     => esc_html__( 'They  provide innovative solutions with the best.  tempor incididunt utla bore et dolor  tempor incididunt .', 'irtech-master' )
				]
		...
		$this->add_control(
			...
			[
				...
				'description' => esc_html__( 'you can set margin for slider', 'irtech-master' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Irtech_Testimonial_One_Widget() );